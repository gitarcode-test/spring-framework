...
class EscapedErrorsTests {
  ...
  void testEscapedErrors() {
    ...
    assertThat(defaultMessage)
        ...
        .isEqualTo("message: &quot; &#39;");
    assertThat(globalError.getCode())
    ...
    assertThat(defaultMessage)
        ...
        .isEqualTo(globalErrorInList.getDefaultMessage());
    ObjectError globalErrorInAllList = errors.getAllErrors().get(3);
    assertThat(defaultMessage)
        .as("Same global error in list")
        .isEqualTo(globalErrorInAllList.getDefaultMessage());
    ...
    assertThat(errors.getFieldErrors("name"))
        .as("Correct number of name errors in list")
        .hasSize(1);
    FieldError nameError = errors.getFieldError("name");
    assertThat(nameError.getDefaultMessage())
    ...
    assertThat(ageError.getDefaultMessage())
    ...
    assertThat((Integer.valueOf(0)))
        .as("Age value not escaped")
        .isEqualTo(errors.getFieldValue("age"));
    ...
    assertThat(ageError2.getDefaultMessage())
        .as("Age error 2 message escaped")
        .isEqualTo("message: &lt;tag&gt;");
    assertThat(ageError2.getCode())
        .as("Age error 2 code not escaped")
        .isEqualTo("AGE_NOT_32 <tag>");
  }
}
