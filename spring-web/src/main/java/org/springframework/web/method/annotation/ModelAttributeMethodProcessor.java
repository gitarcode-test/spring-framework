...
public class ModelAttributeMethodProcessor
  ...
  @Nullable
  private static Object wrapAsOptionalIfNecessary(
      MethodParameter parameter, @Nullable Object target) {
   ...
   *
   * <p>By default, as of 6.1 this method returns {@code null} in which case {@link
   * org.springframework.validation.DataBinder#construct} is used instead to create the model
   * attribute. The main purpose of this method then is to allow to create the model attribute in
   * some other, alternative way.
   *
   ...
   *
   * <p>The default implementation checks for {@code @jakarta.validation.Valid}, Spring's {@link
