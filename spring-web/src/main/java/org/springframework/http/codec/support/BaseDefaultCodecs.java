...
class BaseDefaultCodecs
  ...
  @Nullable private Decoder<?> kotlinSerializationCborDecoder;

  @Nullable private Encoder<?> kotlinSerializationCborEncoder;

  @Nullable private Decoder<?> kotlinSerializationJsonDecoder;

  @Nullable private Encoder<?> kotlinSerializationJsonEncoder;

  @Nullable private Decoder<?> kotlinSerializationProtobufDecoder;

  @Nullable private Encoder<?> kotlinSerializationProtobufEncoder;
  ...
  @Nullable private Consumer<Object> codecConsumer;
  ...
  public void configureDefaultCodec(Consumer<Object> codecConsumer) {
    this.codecConsumer =
        (this.codecConsumer != null ? this.codecConsumer.andThen(codecConsumer) : codecConsumer);
    initReaders();
    initWriters();
  }
  ...
  protected void initTypedReaders() {
    ...
    if (protobufPresent) {
      ...
      addCodec(
          this.typedReaders,
          new DecoderHttpMessageReader<>(
              this.kotlinSerializationProtobufDecoder != null
  ...
  /**
   * Apply {@link #maxInMemorySize()} and {@link #enableLoggingRequestDetails}, if configured by the
   * application, to the given codec , including any codec it contains.
   */
  ...
  protected void initObjectReaders() {
    ...
    if (kotlinSerializationCborPresent) {
      addCodec(
          this.objectReaders,
          new DecoderHttpMessageReader<>(
              this.kotlinSerializationCborDecoder != null
                  ? (KotlinSerializationCborDecoder) this.kotlinSerializationCborDecoder
                  : new KotlinSerializationCborDecoder()));
    }
    if (kotlinSerializationJsonPresent) {
      addCodec(
          this.objectReaders, new DecoderHttpMessageReader<>(getKotlinSerializationJsonDecoder()));
    }
    if (kotlinSerializationProtobufPresent) {
      addCodec(
          this.objectReaders,
  ...
  final List<HttpMessageWriter<?>> getBaseTypedWriters() {
    ...
    addCodec(
        writers, new MultipartHttpMessageWriter(this::getPartWriters, new FormHttpMessageWriter()));
  ...
  final List<HttpMessageWriter<?>> getBaseObjectWriters() {
    ...
    if (kotlinSerializationCborPresent) {
      addCodec(
          ...
          new EncoderHttpMessageWriter<>(
              this.kotlinSerializationCborEncoder != null
    ...
    if (kotlinSerializationProtobufPresent) {
      addCodec(
          writers,
          new EncoderHttpMessageWriter<>(
              this.kotlinSerializationProtobufEncoder != null
