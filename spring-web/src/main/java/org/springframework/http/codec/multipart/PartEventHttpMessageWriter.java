...
/**
 * {@link HttpMessageWriter} for writing {@link PartEvent} objects. Useful for server-side proxies,
 * that relay multipart requests to others services.
 *
 * @author Arjen Poutsma
 * @since 6.0
 * @see PartEvent
 */
public class PartEventHttpMessageWriter extends MultipartWriterSupport
  ...
  public Mono<Void> write(
      Publisher<? extends PartEvent> partDataStream,
