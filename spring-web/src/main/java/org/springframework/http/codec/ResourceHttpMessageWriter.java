...
public class ResourceHttpMessageWriter implements HttpMessageWriter<Resource> {
                ...
                () -> {
                  ...
                  if (result != null) {
                    ...
                    Flux<DataBuffer> body =
                        this.encoder
                            .encode(
                                input, factory, type, message.getHeaders().getContentType(), hints)
  ...
  @Nullable
  private static Mono<Void> zeroCopy(
      Resource resource,
      @Nullable ResourceRegion region,
      ReactiveHttpOutputMessage message,
      Map<String, Object> hints) {

    if (message instanceof ZeroCopyHttpOutputMessage zeroCopyHttpOutputMessage
        && resource.isFile()) {
      try {
