...
public class DefaultTransactionDefinition implements TransactionDefinition, Serializable {
  ...
  /**
   * Map of constant names to constant values for the propagation constants defined in {@link
   * TransactionDefinition}.
   */
  static final Map<String, Integer> propagationConstants =
      Map.of(
  ...
  /**
   * Map of constant names to constant values for the isolation constants defined in {@link
   * TransactionDefinition}.
   */
  static final Map<String, Integer> isolationConstants =
      Map.of(
  ...
  /**
   * Create a new {@code DefaultTransactionDefinition} with default settings. Can be modified
  ...
  /**
   * Create a new {@code DefaultTransactionDefinition} with the given propagation behavior. Can be
  ...
  /**
   * Set the propagation behavior by the name of the corresponding constant in {@link
   * TransactionDefinition} &mdash; for example, {@code "PROPAGATION_REQUIRED"}.
   *
  ...
  public final void setPropagationBehavior(int propagationBehavior) {
    Assert.isTrue(
        propagationConstants.containsValue(propagationBehavior),
  ...
  /**
   * Set the isolation level by the name of the corresponding constant in {@link
   * TransactionDefinition} &mdash; for example, {@code "ISOLATION_DEFAULT"}.
   *
   * @param constantName name of the constant
   * @throws IllegalArgumentException if the supplied value is not resolvable to one of the {@code
  ...
  public final void setIsolationLevel(int isolationLevel) {
    Assert.isTrue(
        isolationConstants.containsValue(isolationLevel),
    ...
    return switch (propagationBehavior) {
      ...
      default ->
          throw new IllegalArgumentException(
              "Unsupported propagation behavior: " + propagationBehavior);
    };
  }
