...
class BindTagTests extends AbstractTagTests {
  ...
  void bindTagWithoutErrors() throws JspException {
    ...
    tag.setPath("tb");
    assertThat(tag.doStartTag())
        .as("Correct doStartTag return value")
        .isEqualTo(Tag.EVAL_BODY_INCLUDE);
    BindStatus status =
  ...
  void bindTagWithFieldErrors() throws JspException {
    ...
    assertThat(status.getErrorMessages()[0])
  ...
  void bindErrorsTagWithoutErrors() throws JspException {
    ...
    assertThat(pc.getAttribute(BindErrorsTag.ERRORS_VARIABLE_NAME))
  ...
  void bindErrorsTagWithErrors() throws JspException {
    ...
    assertThat(tag.doStartTag())
        .as("Correct doStartTag return value")
        .isEqualTo(Tag.EVAL_BODY_INCLUDE);
    assertThat(pc.getAttribute(BindErrorsTag.ERRORS_VARIABLE_NAME, PageContext.REQUEST_SCOPE))
  ...
  void nestedPathWithBindTag() throws JspException {
    ...
    assertThat(bindTag2.doStartTag())
        .as("Correct doStartTag return value")
        .isEqualTo(Tag.EVAL_BODY_INCLUDE);
    BindStatus status2 =
        (BindStatus) pc.getAttribute(BindTag.STATUS_VARIABLE_NAME, PageContext.REQUEST_SCOPE);
