...
/**
 * A test fixture with a subclass of {@link WebMvcConfigurationSupport} that also implements the
...
class WebMvcConfigurationSupportExtensionTests {
  ...
  void requestMappingHandlerAdapter() {
    ...
    assertThat(fieldAccessor.getPropertyValue("ignoreDefaultModelOnRedirect"))
