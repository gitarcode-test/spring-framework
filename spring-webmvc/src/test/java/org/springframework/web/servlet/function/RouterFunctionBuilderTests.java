...
class RouterFunctionBuilderTests {
  ...
  void route() {
    ...
    Optional<HttpStatusCode> responseStatus =
        route
            .route(getFooRequest)
  ...
  void resource() {
    Resource resource =
        new ClassPathResource("/org/springframework/web/servlet/function/response.txt");
  ...
  private ServerRequest initRequest(
    ...
    return new DefaultServerRequest(
        PathPatternsTestUtils.initRequest(httpMethod, null, requestUri, true, consumer),
        emptyList());
  }
