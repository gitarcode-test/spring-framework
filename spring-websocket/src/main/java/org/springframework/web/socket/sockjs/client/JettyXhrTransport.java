...
public class JettyXhrTransport extends AbstractXhrTransport implements Lifecycle {
  ...
  /**
   * Jetty client {@link org.eclipse.jetty.client.Response.Listener Response Listener} that splits
   * the body of the response into SockJS frames and delegates them to the {@link
