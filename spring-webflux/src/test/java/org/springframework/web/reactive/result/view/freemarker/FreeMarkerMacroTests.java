...
class FreeMarkerMacroTests {
  ...
  void springMacroRequestContextIsAutomaticallyExposedAsModelAttribute() throws Exception {
    ...
    StepVerifier.create(
            view.render(model, null, this.exchange).then(Mono.fromCallable(this::getOutput)))
  ...
  void formTextareaWithCustomRowsAndColumns() throws Exception {
    testMacroOutput(
        "FORM4", "<textarea id=\"name\" name=\"name\" rows=10 cols=30>Darren</textarea>");
  }
  ...
  void formCheckboxForStringArray() throws Exception {
    testMacroOutput(
        ...
        "<input type=\"checkbox\" id=\"stringArray1\" name=\"stringArray\" value=\"John\""
            + " checked=\"checked\" >", //
        "<label for=\"stringArray1\">John Doe</label>", //
        "<input type=\"checkbox\" id=\"stringArray2\" name=\"stringArray\" value=\"Fred\""
            + " checked=\"checked\" >", //
  ...
  void formPasswordInput() throws Exception {
    testMacroOutput("FORM9", "<input type=\"password\" id=\"name\" name=\"name\" value=\"\" >");
  }

  @Test
  void formHiddenInput() throws Exception {
    testMacroOutput(
        "FORM10", "<input type=\"hidden\" id=\"name\" name=\"name\" value=\"Darren\" >");
  }

  @Test
  void formInputText() throws Exception {
    testMacroOutput("FORM11", "<input type=\"text\" id=\"name\" name=\"name\" value=\"Darren\" >");
  }

  @Test
  void formInputHidden() throws Exception {
    testMacroOutput(
        "FORM12", "<input type=\"hidden\" id=\"name\" name=\"name\" value=\"Darren\" >");
  }

  @Test
  void formInputPassword() throws Exception {
    testMacroOutput("FORM13", "<input type=\"password\" id=\"name\" name=\"name\" value=\"\" >");
  }
  ...
  private Mono<List<String>> getMacroOutput(String name) throws Exception {
    ...
    return view.render(model, null, this.exchange).then(Mono.fromCallable(this::getOutput));
  }
  ...
  private void storeTemplateInTempDir(String macro) throws IOException {
    Files.writeString(
        this.templateLoaderPath.resolve("tmp.ftl"),
