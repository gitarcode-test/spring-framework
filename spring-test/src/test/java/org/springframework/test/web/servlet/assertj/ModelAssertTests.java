...
class ModelAssertTests {
  ...
  void doesNotHaveErrorsWithError() {
    AssertProvider<ModelAssert> actual =
        forModel(new TestBean(), Map.of("name", "John", "age", "4x"));
    assertThatExceptionOfType(AssertionError.class)
  ...
  void hasErrorsWithMatchingAttributes() {
    ...
    augmentModel(
        model, "wrong2", new TestBean(), Map.of("name", "third", "touchy", "invalid.name"));
  ...
  void hasErrorsWithOneNonMatchingAttribute() {
    ...
    assertThatExceptionOfType(AssertionError.class)
        ...
        .withMessageContainingAll(
            ...
            "wrong1, valid",
            "but these attributes do not have any errors:",
            "valid");
  }
  ...
  void hasErrorsWithOneNonMatchingAttributeAndOneUnknownAttribute() {
    ...
    assertThatExceptionOfType(AssertionError.class)
        ...
        .withMessageContainingAll(
            "to have attribute errors for:",
            "wrong1, unknown, valid",
            "but could not find these attributes:",
            "unknown",
            "and these attributes do not have any errors:",
            "valid");
  }
  ...
  void doesNotHaveErrorsWithOneNonMatchingAttribute() {
    ...
    assertThatExceptionOfType(AssertionError.class)
        ...
        .withMessageContainingAll(
            ...
            "valid1, wrong",
            "but these attributes have at least one error:",
            "wrong");
  }
  ...
  void doesNotHaveErrorsWithOneNonMatchingAttributeAndOneUnknownAttribute() {
    ...
    assertThatExceptionOfType(AssertionError.class)
        ...
        .withMessageContainingAll(
            "to have attribute without errors for:",
            "valid1, unknown, wrong",
            "but could not find these attributes:",
            "unknown",
            "and these attributes have at least one error:",
            "wrong");
  }
  ...
  private AssertProvider<ModelAssert> forModel(
      Object instance, Map<String, Object> propertyValues) {
    Map<String, Object> model = new HashMap<>();
    augmentModel(model, "test", instance, propertyValues);
    return forModel(model);
  }

  private static void augmentModel(
