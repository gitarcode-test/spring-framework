...
class IsolationLevelDataSourceRouterTests {
  ...
  void resolveSpecifiedLookupKeyForInvalidTypes() {
    assertThatIllegalArgumentException()
        .isThrownBy(() -> router.resolveSpecifiedLookupKey(new Object()));
  ...
  void resolveSpecifiedLookupKeyByNameForUnsupportedValues() {
    ...
    assertThatIllegalArgumentException()
        .isThrownBy(() -> router.resolveSpecifiedLookupKey("bogus"));
  }
  ...
  void resolveSpecifiedLookupKeyByNameForAllSupportedValues() {
    ...
    assertThat(uniqueValues)
        .containsExactlyInAnyOrderElementsOf(IsolationLevelDataSourceRouter.constants.values());
  }
  ...
  void resolveSpecifiedLookupKeyByInteger() {
    ...
    assertThat(router.resolveSpecifiedLookupKey(ISOLATION_READ_UNCOMMITTED))
        .isEqualTo(ISOLATION_READ_UNCOMMITTED);
    assertThat(router.resolveSpecifiedLookupKey(ISOLATION_READ_COMMITTED))
        .isEqualTo(ISOLATION_READ_COMMITTED);
    assertThat(router.resolveSpecifiedLookupKey(ISOLATION_REPEATABLE_READ))
        .isEqualTo(ISOLATION_REPEATABLE_READ);
    assertThat(router.resolveSpecifiedLookupKey(ISOLATION_SERIALIZABLE))
        .isEqualTo(ISOLATION_SERIALIZABLE);
  }
}
