...
public class ImportSelectorTests {
  ...
  void filteredImportSelector() {
    ...
    assertThat(beanNames)
        .endsWith("importSelectorTests.FilteredConfig", ImportedSelector2.class.getName(), "b");
  ...
  public static class FilteredImportSelector implements ImportSelector {
    ...
    public String[] selectImports(AnnotationMetadata importingClassMetadata) {
      return new String[] {
        ImportedSelector1.class.getName(),
        ImportedSelector2.class.getName(),
        ImportedSelector3.class.getName()
      };
    }
    ...
    public Predicate<String> getExclusionFilter() {
      return (className ->
          className.equals(ImportedSelector1.class.getName())
