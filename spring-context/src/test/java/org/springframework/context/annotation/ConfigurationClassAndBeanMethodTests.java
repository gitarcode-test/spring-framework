...
/**
 * Integration tests for {@link ConfigurationClassParser}, {@link ConfigurationClass}, and {@link
 * BeanMethod}.
 *
 * @author Sam Brannen
 * @since 5.3.9
...
class ConfigurationClassAndBeanMethodTests {
  ...
  void verifyEquals() throws Exception {
    ...
    assertThat(beanMethod_1_0.getMetadata().getMethodName())
        .isEqualTo(beanMethod_3_0.getMetadata().getMethodName());
  ...
  void verifyToString() throws Exception {
    ...
    assertThat(beanMethods.get(2).toString())
        .isEqualTo(prefix + ".bean2(java.lang.String,java.lang.Integer)");
  }
