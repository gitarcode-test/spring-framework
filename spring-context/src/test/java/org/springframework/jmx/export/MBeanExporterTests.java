...
class MBeanExporterTests extends AbstractMBeanServerTests {
  ...
  void registerIgnoreExisting() throws Exception {
    ...
    Map<String, Object> beans =
        Map.of(objectName.toString(), springRegistered, objectName2, springRegistered);
   ...
   * autodetect constants defined in {@link MBeanExporter}.
   */
  @Test
  @SuppressWarnings("deprecation")
  ...
  @Test // SPR-2158
  void mbeanIsNotUnregisteredSpuriouslyIfSomeExternalProcessHasUnregisteredMBean()
      throws Exception {
    exporter.setBeans(getBeanMap());
    ...
    assertThat(listener.getUnregistered())
        .as(
            "Listener should not have been invoked (MBean previously unregistered by external"
                + " agent)")
        .isEmpty();
  }
  ...
  void mbeanIsUnregisteredForRuntimeExceptionDuringInitialization() throws Exception {
    ...
    exporter.setServer(getServer());
    Map<String, Object> beansToExport =
        Map.of(
  ...
  private static void assertListener(MockMBeanExporterListener listener)
