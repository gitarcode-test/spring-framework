...
public class InjectionMetadata {
  ...
  /**
   * Return the {@link InjectedElement elements} to inject based on the specified {@link
   * PropertyValues}. If a property is already defined for an {@link InjectedElement}, it is
   * excluded.
   *
  ...
  public void checkConfigMembers(RootBeanDefinition beanDefinition) {
    if (this.injectedElements.isEmpty()) {
      ...
      Set<InjectedElement> checkedElements =
          CollectionUtils.newLinkedHashSet(this.injectedElements.size());
  ...
  public abstract static class InjectedElement {
    ...
    protected void clearPropertySkipping(@Nullable PropertyValues pvs) {
      ...
      synchronized (pvs) {
        if (Boolean.FALSE.equals(this.skip)
            && this.pd != null
            && pvs instanceof MutablePropertyValues mpvs) {
    ...
    public boolean equals(@Nullable Object other) {
      return (this == other
          || (other instanceof InjectedElement that && this.member.equals(that.member)));
    }
