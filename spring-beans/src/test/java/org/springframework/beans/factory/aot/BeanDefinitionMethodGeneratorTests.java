...
/**
 * Tests for {@link BeanDefinitionMethodGenerator} and {@link DefaultBeanRegistrationCodeFragments}.
 *
 * @author Phillip Webb
...
class BeanDefinitionMethodGeneratorTests {
  ...
  BeanDefinitionMethodGeneratorTests() {
    ...
    this.methodGeneratorFactory =
        new BeanDefinitionMethodGeneratorFactory(
  ...
  void generateWithBeanClassSetsOnlyBeanClass() {
    ...
    BeanDefinitionMethodGenerator generator =
        new BeanDefinitionMethodGenerator(
            this.methodGeneratorFactory, registeredBean, null, Collections.emptyList());
    MethodReference method =
        generator.generateBeanDefinitionMethod(this.generationContext, this.beanRegistrationsCode);
    compile(
        method,
        (actual, compiled) -> {
    ...
    compile(
        ...
        (actual, compiled) -> {
          ...
          assertThat(sourceFile)
              .contains(
                  "setTargetType(ResolvableType.forClassWithGenerics(GenericBean.class,"
                      + " Integer.class))");
  ...
  void generateWithBeanClassAndFactoryMethodNameSetsTargetTypeAndBeanClass() {
    this.beanFactory.registerBeanDefinition(
        "factory", new RootBeanDefinition(SimpleBeanConfiguration.class));
  ...
  void generateWithBeanClassAndTargetTypeDifferentSetsBoth() {
    ...
    beanDefinition.setResolvedFactoryMethod(
        ReflectionUtils.findMethod(TestHierarchy.class, "oneBean"));
    RegisteredBean registeredBean = registerBean(beanDefinition);
    BeanDefinitionMethodGenerator generator =
        new BeanDefinitionMethodGenerator(
            this.methodGeneratorFactory, registeredBean, null, Collections.emptyList());
  ...
  void generateBeanDefinitionMethodUSeBeanClassNameIfNotReachable() {
    ...
    compile(
        ...
        (actual, compiled) -> {
          ...
          assertThat(sourceFile)
              .contains(
                  "new RootBeanDefinition(\"org.springframework.beans.factory.aot.PackagePrivateTestBean\"");
  ...
  void generateBeanDefinitionMethodWhenHasInnerClassTargetMethodGeneratesMethod() {
    this.beanFactory.registerBeanDefinition(
        "testBeanConfiguration", new RootBeanDefinition(InnerBeanConfiguration.Simple.class));
    RootBeanDefinition beanDefinition = new RootBeanDefinition(SimpleBean.class);
    ...
    compile(
        ...
        (actual, compiled) -> {
          ...
          assertThat(sourceFile)
              .contains("public static class Simple")
  ...
  void generateBeanDefinitionMethodWhenHasNestedInnerClassTargetMethodGeneratesMethod() {
    this.beanFactory.registerBeanDefinition(
        ...
        new RootBeanDefinition(InnerBeanConfiguration.Simple.Another.class));
    RootBeanDefinition beanDefinition = new RootBeanDefinition(SimpleBean.class);
    beanDefinition.setFactoryBeanName("testBeanConfiguration");
  ...
  void generateBeanDefinitionMethodWhenHasExplicitResolvableType() {
    ...
    compile(
        method,
        (actual, compiled) ->
            assertThat(actual.getResolvableType().resolve()).isEqualTo(Two.class));
  }
  ...
  void generateBeanDefinitionMethodWhenHasInstancePostProcessorGeneratesMethod() {
    ...
    BeanRegistrationAotContribution aotContribution =
        (generationContext, beanRegistrationCode) -> {
    ...
    List<BeanRegistrationAotContribution> aotContributions =
        Collections.singletonList(aotContribution);
    BeanDefinitionMethodGenerator generator =
        new BeanDefinitionMethodGenerator(
  ...
  void generateBeanDefinitionMethodWhenHasInstancePostProcessorAndFactoryMethodGeneratesMethod() {
    this.beanFactory.registerBeanDefinition(
        "testBeanConfiguration", new RootBeanDefinition(TestBeanConfiguration.class));
    RootBeanDefinition beanDefinition = new RootBeanDefinition(TestBean.class);
    beanDefinition.setFactoryBeanName("testBeanConfiguration");
  ...
  private BeanRegistrationCodeFragments customizeBeanDefinitionCode(
    ...
    return new BeanRegistrationCodeFragmentsDecorator(codeFragments) {
      ...
      public CodeBlock generateNewBeanDefinitionCode(
        ...
        code.add(
            super.generateNewBeanDefinitionCode(generationContext, beanType, beanRegistrationCode));
        return code.build();
      }
    };
  }
  ...
  private BeanRegistrationCodeFragments customizeAttributeFilter(
    ...
    return new BeanRegistrationCodeFragmentsDecorator(codeFragments) {
      ...
      public CodeBlock generateSetBeanDefinitionPropertiesCode(
        ...
        return super.generateSetBeanDefinitionPropertiesCode(
            generationContext, beanRegistrationCode, beanDefinition, "a"::equals);
      }
    };
  }
  ...
  void generateBeanDefinitionMethodWhenInnerBeanGeneratesMethod() {
    ...
    RegisteredBean innerBean =
        RegisteredBean.ofInnerBean(parent, new RootBeanDefinition(AnnotatedBean.class));
    BeanDefinitionMethodGenerator generator =
        new BeanDefinitionMethodGenerator(
            this.methodGeneratorFactory, innerBean, "testInnerBean", Collections.emptyList());
    MethodReference method =
        generator.generateBeanDefinitionMethod(this.generationContext, this.beanRegistrationsCode);
    compile(
        method,
  ...
  void generateBeanDefinitionMethodWhenHasInnerBeanPropertyValueGeneratesMethod() {
    RootBeanDefinition innerBeanDefinition =
        (RootBeanDefinition)
    ...
    compile(
        method,
        (actual, compiled) -> {
          RootBeanDefinition actualInnerBeanDefinition =
              (RootBeanDefinition) actual.getPropertyValues().get("name");
  ...
  void generateBeanDefinitionMethodWhenHasListOfInnerBeansPropertyValueGeneratesMethod() {
    RootBeanDefinition firstInnerBeanDefinition =
        (RootBeanDefinition)
            BeanDefinitionBuilder.rootBeanDefinition(TestBean.class)
                .addPropertyValue("name", "one")
                .getBeanDefinition();
    RootBeanDefinition secondInnerBeanDefinition =
        (RootBeanDefinition)
            BeanDefinitionBuilder.rootBeanDefinition(TestBean.class)
                .addPropertyValue("name", "two")
                .getBeanDefinition();
    ...
    compile(
        method,
        (actual, compiled) -> {
          ManagedList<RootBeanDefinition> actualPropertyValue =
              (ManagedList<RootBeanDefinition>) actual.getPropertyValues().get("someList");
          ...
          RootBeanDefinition actualInnerBeanDefinition =
              (RootBeanDefinition)
                  actual
                      ...
                      .getIndexedArgumentValue(0, RootBeanDefinition.class)
                      .getValue();
          assertThat(actualInnerBeanDefinition.isPrimary()).isTrue();
          assertThat(actualInnerBeanDefinition.getRole())
              .isEqualTo(BeanDefinition.ROLE_INFRASTRUCTURE);
  ...
  void generateBeanDefinitionMethodWhenCustomPropertyValueUsesCustomDelegate() {
    ...
    beanDefinition
        .getPropertyValues()
        .addPropertyValue("customPropertyValue", new CustomPropertyValue("test"));
    RegisteredBean bean = registerBean(beanDefinition);
    BeanDefinitionMethodGenerator generator =
        new BeanDefinitionMethodGenerator(
            this.methodGeneratorFactory, bean, "test", Collections.emptyList());
    MethodReference method =
        generator.generateBeanDefinitionMethod(this.generationContext, this.beanRegistrationsCode);
    compile(
        method,
  ...
  void generateBeanDefinitionMethodWhenHasAotContributionsAppliesContributions() {
    ...
    aotContributions.add(
        (generationContext, beanRegistrationCode) ->
            beanRegistrationCode
                .getMethods()
                .add("aotContributedMethod", method -> method.addComment("Example Contribution")));
    BeanDefinitionMethodGenerator generator =
        new BeanDefinitionMethodGenerator(
            this.methodGeneratorFactory, registeredBean, null, aotContributions);
    MethodReference method =
  ...
  void generateBeanDefinitionMethodWhenPackagePrivateBean() {
    RegisteredBean registeredBean =
        registerBean(new RootBeanDefinition(PackagePrivateTestBean.class));
    BeanDefinitionMethodGenerator generator =
        new BeanDefinitionMethodGenerator(
            this.methodGeneratorFactory, registeredBean, null, Collections.emptyList());
    MethodReference method =
    ...
    compile(
        ...
        (actual, compiled) -> {
          ...
          assertThat(
                  compiled.getSourceFileFromPackage(PackagePrivateTestBean.class.getPackageName()))
              .isNotNull();
        });
  }
  ...
  void generateBeanDefinitionMethodWhenBeanIsInJavaxPackage() {
    RootBeanDefinition beanDefinition =
        (RootBeanDefinition)
            BeanDefinitionBuilder.rootBeanDefinition(DocumentBuilderFactory.class)
                .setFactoryMethod("newDefaultInstance")
                .getBeanDefinition();
  ...
  void generateBeanDefinitionMethodWhenBeanIsOfPrimitiveType() {
    RootBeanDefinition beanDefinition =
        (RootBeanDefinition)
            BeanDefinitionBuilder.rootBeanDefinition(Boolean.class)
                .setFactoryMethod("parseBoolean")
  ...
  void generateBeanDefinitionMethodWhenInstanceSupplierWithNoCustomization() {
    RegisteredBean registeredBean =
        registerBean(new RootBeanDefinition(TestBean.class, TestBean::new));
    BeanDefinitionMethodGenerator generator =
        new BeanDefinitionMethodGenerator(
    ...
    assertThatExceptionOfType(AotBeanProcessingException.class)
        .isThrownBy(
            () ->
                generator.generateBeanDefinitionMethod(
  ...
  void generateBeanDefinitionMethodWhenInstanceSupplierWithOnlyCustomTarget() {
    BeanRegistrationAotContribution aotContribution =
        BeanRegistrationAotContribution.withCustomCodeFragments(
            defaultCodeFragments ->
                new BeanRegistrationCodeFragmentsDecorator(defaultCodeFragments) {
                  @Override
    ...
    BeanDefinitionMethodGenerator generator =
        new BeanDefinitionMethodGenerator(
            this.methodGeneratorFactory, registeredBean, null, List.of(aotContribution));
    assertThatExceptionOfType(AotBeanProcessingException.class)
        .isThrownBy(
            () ->
                generator.generateBeanDefinitionMethod(
  ...
  class DeprecationTests {
    ...
    private static final TestCompiler TEST_COMPILER =
        TestCompiler.forSystem().withCompilerOptions("-Xlint:all", "-Xlint:-rawtypes", "-Werror");
    ...
    void generateBeanDefinitionMethodWithDeprecatedTargetClass() {
      ...
      BeanDefinitionMethodGenerator generator =
          new BeanDefinitionMethodGenerator(
              methodGeneratorFactory, registeredBean, null, Collections.emptyList());
      MethodReference method =
          generator.generateBeanDefinitionMethod(generationContext, beanRegistrationsCode);
    ...
    private void compileAndCheckWarnings(MethodReference methodReference) {
      assertThatNoException()
          .isThrownBy(
              () -> compile(TEST_COMPILER, methodReference, ((instanceSupplier, compiled) -> {})));
    }
  }

  private void testBeanDefinitionMethodInCurrentFile(
      Class<?> targetType, RootBeanDefinition beanDefinition) {
  ...
  private void compile(
    ...
    this.beanRegistrationsCode
        ...
        .set(
            type -> {
              CodeBlock methodInvocation =
                  method.toInvokeCodeBlock(
                      ArgumentCodeGenerator.none(), this.beanRegistrationsCode.getClassName());
              ...
              type.addMethod(
                  MethodSpec.methodBuilder("get")
                      ...
                      .addCode("return $L;", methodInvocation)
                      .build());
            });
    ...
    testCompiler
        ...
        .compile(
            compiled ->
                result.accept(
                    (RootBeanDefinition) compiled.getInstance(Supplier.class).get(), compiled));
  }
}
