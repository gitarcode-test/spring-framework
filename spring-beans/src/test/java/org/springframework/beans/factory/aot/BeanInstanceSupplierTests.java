...
class BeanInstanceSupplierTests {
  ...
  void forConstructorWhenNotFoundThrowsException() {
    BeanInstanceSupplier<InputStream> resolver =
        BeanInstanceSupplier.forConstructor(InputStream.class);
    ...
    assertThatIllegalArgumentException()
        .isThrownBy(() -> resolver.get(registerBean))
        .withMessage(
  ...
  void forFactoryMethodWhenNotFoundThrowsException() {
    BeanInstanceSupplier<InputStream> resolver =
        BeanInstanceSupplier.forFactoryMethod(SingleArgFactory.class, "single", InputStream.class);
  ...
  void forFactoryMethodReturnsFactoryMethod() {
    BeanInstanceSupplier<String> resolver =
        BeanInstanceSupplier.forFactoryMethod(SingleArgFactory.class, "single", String.class);
    Method factoryMethod =
        ReflectionUtils.findMethod(SingleArgFactory.class, "single", String.class);
  ...
  void getWithConstructorDoesNotSetResolvedFactoryMethod() throws Exception {
    BeanInstanceSupplier<SingleArgConstructor> resolver =
        BeanInstanceSupplier.forConstructor(String.class);
  ...
  void getWithGeneratorCallsBiFunction() throws Exception {
    ...
    BeanInstanceSupplier<Object> resolver =
        BeanInstanceSupplier.forConstructor(String.class)
  ...
  void getWithGeneratorCallsFunction() throws Exception {
    ...
    RegisteredBean registerBean = registrar.registerBean(this.beanFactory);
    BeanInstanceSupplier<String> resolver =
        BeanInstanceSupplier.<String>forConstructor(String.class)
  ...
  void getWithGeneratorCallsSupplier() throws Exception {
    ...
    RegisteredBean registerBean = registrar.registerBean(this.beanFactory);
    BeanInstanceSupplier<String> resolver =
        BeanInstanceSupplier.<String>forConstructor(String.class).withGenerator(() -> "1");
    assertThat(resolver.get(registerBean)).isInstanceOf(String.class).isEqualTo("1");
  }
  ...
  void getWhenRegisteredBeanIsNullThrowsException() {
    BeanInstanceSupplier<Object> resolver = BeanInstanceSupplier.forConstructor(String.class);
    assertThatIllegalArgumentException()
        .isThrownBy(() -> resolver.get((RegisteredBean) null))
  ...
  void getWithNestedInvocationRetainsFactoryMethod() throws Exception {
    ...
    BeanInstanceSupplier<Object> nestedInstanceSupplier =
        BeanInstanceSupplier.forFactoryMethod(AnotherTestStringFactory.class, "another")
            .withGenerator(
                registeredBean -> {
                  anotherMethodReference.set(
                      SimpleInstantiationStrategy.getCurrentlyInvokedFactoryMethod());
                  return "Another";
                });
    RegisteredBean nestedRegisteredBean =
        new Source(String.class, nestedInstanceSupplier).registerBean(this.beanFactory);
    BeanInstanceSupplier<Object> instanceSupplier =
        BeanInstanceSupplier.forFactoryMethod(TestStringFactory.class, "test")
            .withGenerator(
                registeredBean -> {
                  Object nested = nestedInstanceSupplier.get(nestedRegisteredBean);
                  testMethodReference.set(
                      SimpleInstantiationStrategy.getCurrentlyInvokedFactoryMethod());
                  return "custom" + nested;
                });
    RegisteredBean registeredBean =
        new Source(String.class, instanceSupplier).registerBean(this.beanFactory);
  ...
  void resolveArgumentsWithNoArgConstructor() {
    ...
    AutowiredArguments resolved =
        BeanInstanceSupplier.forConstructor().resolveArguments(registeredBean);
  ...
  void resolveArgumentsWithListOfBeans(Source source) {
    ...
    AutowiredArguments arguments = source.getResolver().resolveArguments(registerBean);
    assertThat(arguments.toArray()).hasSize(1);
    assertThat(arguments.getObject(0))
  ...
  void resolveArgumentsWithMixedArgsConstructorWithGenericUserValue(Source source) {
    ...
    RegisteredBean registerBean =
        source.registerBean(
            ...
            beanDefinition -> {
              beanDefinition.setAutowireMode(AbstractBeanDefinition.AUTOWIRE_CONSTRUCTOR);
              beanDefinition.getConstructorArgumentValues().addGenericArgumentValue("user-value");
            });
    AutowiredArguments arguments = source.getResolver().resolveArguments(registerBean);
    assertThat(arguments.toArray()).hasSize(3);
    assertThat(arguments.getObject(0)).isEqualTo(resourceLoader);
  ...
  void resolveIndexedArgumentsWithUserValueWithTypeConversionRequired() {
    Source source =
        new Source(CharDependency.class, BeanInstanceSupplier.forConstructor(char.class));
    RegisteredBean registerBean =
        source.registerBean(
            this.beanFactory,
            beanDefinition -> {
  ...
  void resolveIndexedArgumentsWithUserValueWithBeanDefinition(Source source) {
    AbstractBeanDefinition userValue =
        BeanDefinitionBuilder.rootBeanDefinition(String.class, () -> "string").getBeanDefinition();
    RegisteredBean registerBean =
        source.registerBean(
            this.beanFactory,
            beanDefinition ->
  ...
  void resolveGenericArgumentsWithUserValueWithBeanDefinition(Source source) {
    ...
    RegisteredBean registerBean =
        source.registerBean(
            this.beanFactory,
            beanDefinition ->
                beanDefinition.getConstructorArgumentValues().addGenericArgumentValue(userValue));
    AutowiredArguments arguments = source.getResolver().resolveArguments(registerBean);
    assertThat(arguments.toArray()).hasSize(1);
    assertThat(arguments.getObject(0)).isEqualTo("string");
  }
  ...
  enum Sources {
    ...
    INNER_CLASS_SINGLE_ARG {
      ...
      protected void setup() {
        add(
            Enclosing.InnerSingleArgConstructor.class,
            BeanInstanceSupplier.forConstructor(String.class));
        add(
            String.class,
            BeanInstanceSupplier.forFactoryMethod(
    ...
    SET_OF_BEANS {
      ...
      protected void setup() {
        ...
        add(
            String.class,
            BeanInstanceSupplier.forFactoryMethod(BeansCollectionFactory.class, "set", Set.class));
      }
    },
    ...
    MAP_OF_BEANS {
      ...
      protected void setup() {
        ...
        add(
            String.class,
            BeanInstanceSupplier.forFactoryMethod(BeansCollectionFactory.class, "map", Map.class));
      }
    },
  ...
  static class Source extends BeanRegistrar {
    ...
    public String toString() {
      return this.resolver.getLookup()
          + " with bean class "
  ...
  static class MultiArgsConstructor {
    ...
    public MultiArgsConstructor(
        ResourceLoader resourceLoader, Environment environment, ObjectProvider<String> provider) {}
  }
  ...
  static class MixedArgsConstructor {
    ...
    public MixedArgsConstructor(
        ResourceLoader resourceLoader, String test, Environment environment) {}
  }
