...
class AopNamespaceHandlerEventTests {
  ...
  void pointcutEvents() {
    ...
    assertThat(componentDefinitions[0])
        .as("No holder with nested components")
        .isInstanceOf(CompositeComponentDefinition.class);
  ...
  void advisorEventsWithPointcutRef() {
    ...
    assertThat(componentDefinitions[1])
        .as("No advice bean found")
        .isInstanceOf(BeanComponentDefinition.class);
