...
public class OpMinus extends Operator {
  ...
  /**
   * Determine if this operator is a unary minus and its child is a {@linkplain
   * Literal#isNumberLiteral() number literal}.
   *
  ...
  public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
    ...
    if (left instanceof String theString
        && right instanceof Integer theInteger
        && theString.length() == 1) {
