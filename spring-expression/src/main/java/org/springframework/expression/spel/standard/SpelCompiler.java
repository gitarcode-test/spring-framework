...
public final class SpelCompiler implements Opcodes {
      ...
      if (clazz != null) {
        try {
          ...
          throw new IllegalStateException(
              "Failed to instantiate CompiledExpression for expression: "
                  + expression.toStringAST(),
              ex);
        }
      }
    }
  ...
  private Class<? extends CompiledExpression> createExpressionClass(
    ...
    // org.springframework.expression.spel.generated.CompiledExpression##### extends
    // org.springframework.expression.spel.CompiledExpression
    String className =
        "org/springframework/expression/spel/generated/CompiledExpression" + getNextSuffix();
    ...
    mv =
        cw.visitMethod(
            ACC_PUBLIC,
            "getValue",
            "(Ljava/lang/Object;L" + evaluationContextClass + ";)Ljava/lang/Object;",
            null,
  ...
  //			if (logger.isDebugEnabled()) {
  //				logger.debug("Saving compiled SpEL expression [%s] to [%s]".formatted(stringAST,
  // path.toAbsolutePath()));
  //			}
