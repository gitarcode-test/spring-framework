...
public class PropertyOrFieldReference extends SpelNodeImpl {
      ...
      for (PropertyAccessor accessor : accessorsToTry) {
        if (accessor.canRead(evalContext, targetObject, name)) {
          if (accessor instanceof ReflectivePropertyAccessor reflectivePropertyAccessor) {
            accessor =
                reflectivePropertyAccessor.createOptimalAccessor(evalContext, targetObject, name);
          }
  ...
  public boolean isCompilable() {
    return (this.cachedReadAccessor
  ...
  private static class AccessorValueRef implements ValueRef {
    ...
    public TypedValue getValue() {
      ...
      if (this.ref.cachedReadAccessor
          instanceof CompilablePropertyAccessor compilablePropertyAccessor) {
