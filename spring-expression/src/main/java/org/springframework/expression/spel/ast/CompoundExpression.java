 ...
 * or {@code property1?.property2?.methodOne()} when the null-safe navigation operator is used.
 *
 * <p>May also contain array/collection/map indexers, such as {@code property1[0].property2['key']}.
 *
 * @author Andy Clement
 * @author Sam Brannen
 * @since 3.0
