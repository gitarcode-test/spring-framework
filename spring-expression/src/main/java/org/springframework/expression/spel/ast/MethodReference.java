...
public class MethodReference extends SpelNodeImpl {
  ...
  @Nullable private Character originalPrimitiveExitTypeDescriptor;
  ...
  private TypedValue getValueInternal(
    ...
    this.cachedExecutor =
        new CachedMethodExecutor(
            executorToUse,
            (value instanceof Class<?> clazz ? clazz : null),
            targetType,
            argumentTypes);
    try {
      return executorToUse.execute(evaluationContext, value, arguments);
  ...
  private void updateExitTypeDescriptor() {
    ...
    if (executorToCheck != null
        && executorToCheck.get() instanceof ReflectiveMethodExecutor reflectiveMethodExecutor) {
  ...
  public void generateCode(MethodVisitor mv, CodeFlow cf) {
    CachedMethodExecutor executorToCheck = this.cachedExecutor;
    if (executorToCheck == null
        || !(executorToCheck.get() instanceof ReflectiveMethodExecutor methodExecutor)) {
