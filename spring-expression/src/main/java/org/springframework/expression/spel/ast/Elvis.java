...
/**
 * Represents the Elvis operator <code>?:</code>. For an expression <code>a?:b</code> if <code>a
 * </code> is neither null nor an empty String, the value of the expression is <code>a</code>. If
 * <code>a</code> is null or the empty String, then the value of the expression is <code>b</code>.
 *
 * @author Andy Clement
...
public class Elvis extends SpelNodeImpl {
  ...
  /**
   * Evaluate the condition and if neither null nor an empty String, return it. If it is null or an
   * empty String, return the other value.
   *
