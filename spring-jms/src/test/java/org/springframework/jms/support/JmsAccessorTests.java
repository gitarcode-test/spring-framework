...
class JmsAccessorTests {
  ...
  void setSessionAcknowledgeModeNameToUnsupportedValues() {
    assertThatIllegalArgumentException()
        .isThrownBy(() -> accessor.setSessionAcknowledgeModeName(null));
    assertThatIllegalArgumentException()
        .isThrownBy(() -> accessor.setSessionAcknowledgeModeName("   "));
    assertThatIllegalArgumentException()
        .isThrownBy(() -> accessor.setSessionAcknowledgeModeName("bogus"));
  }
